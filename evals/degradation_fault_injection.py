...
全部使用内存桩，不发网络请求。运行：
    ...
    .venv/Scripts/python.exe -m evals.degradation_fault_injection

产出：stdout 的 Markdown 报告 + ``evals/results/degradation_fault_injection.json``。
"""
...
from finance_agent.data.provider_manager import ProviderManager  # noqa: E402
from finance_agent.data.providers import (  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--json", default="evals/results/degradation_fault_injection.json")

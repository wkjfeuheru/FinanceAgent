...
class AdvisorSystem:
    ...
    def _trace_agent(self, state: Dict[str, Any], name: str) -> None:
        ...
        print(f"[Agent Flow] {thread_id} | {sequence:02d} -> {name}", flush=True)
    ...
    def handle_message(
        ...
        with self._workflow_lock:
            ...
            state: AdvisorState = {
                ...
                "intent_context": self.memory.build_intent_context(history),
                "thread_id": conversation_id, "run_id": uuid.uuid4().hex,
                "explicit_user_stock_codes": [], "uncertain_intents": [],
                "intent_clarification_state": {}, "intent_clarification_response": "",
            }

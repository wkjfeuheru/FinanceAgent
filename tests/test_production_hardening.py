...
from finance_agent.data.postgres_stores import (
    UniqueConstraintError,
    WEAK_PASSWORDS,
    _validate_password,
    is_unique_violation,
)
from finance_agent.main import fastapi_docs_kwargs
...
def test_production_disables_openapi_docs():
    assert fastapi_docs_kwargs(is_production=True) == {
        "docs_url": None, "redoc_url": None, "openapi_url": None,
    }
    assert fastapi_docs_kwargs(is_production=False) == {}

...
from finance_agent.infrastructure.persistence.postgres import schema as postgres_schema
from finance_agent.infrastructure.persistence.postgres.schema import FAQ_VECTOR_SCHEMA_SQL, HYBRID_ORCHESTRATION_SCHEMA_SQL
...
def test_bigram_migration_defines_chinese_keyword_search():
    ...
    from finance_agent.infrastructure.persistence.postgres.schema import FAQ_BIGRAM_SCHEMA_SQL

...
from finance_agent.domains.faq.documents import FaqDocumentError, parse_faq_markdown
from finance_agent.domains.faq.indexer import FAQ_DOCUMENT_FILES, index_faq_documents, parse_faq_root
...
def test_repo_faq_documents_parse_and_publish_one_version():
    ...
    docs_root = Path(__file__).resolve().parents[2] / "docs" / "faq"

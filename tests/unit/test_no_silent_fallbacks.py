...
from finance_agent.domains.research.evaluation import _evidence_for
...
def test_evidence_never_falls_back_to_other_securities():
    ...
    from finance_agent.domains.research.contracts import SecuritySnapshot as SS
    ...
    owned = _evidence_for(security, others)
    ...
    assert _evidence_for(security, [*others, mine]) == [mine]

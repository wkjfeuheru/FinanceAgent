...
import ProfilePanel from '@/features/auth/components/ProfilePanel.vue'
import HistoryPanel from '@/features/chat/components/HistoryPanel.vue'
import { getProfile, getConversationMessages, getConversations } from '@/features/chat/api'
import type { HistoryMessage } from '@/features/chat/types'
import type { ProfileResponse, UserInfo } from '@/features/auth/types'
